# [Домашнее задание к лекции «Символы, итераторы, генераторы»](https://github.com/netology-code/ajs-homeworks/tree/ajs8/symbols-iterators-generators)
...
## [Символы & итераторы](./src/js/__tests__/team_iterator.test.js)
...
## [Символы и генераторы](./src/js/__tests__/team_generator.test.js)
...
## [Генераторы (задача со звёздочкой)](./src/js/__tests__/can_iterate.test.js)
